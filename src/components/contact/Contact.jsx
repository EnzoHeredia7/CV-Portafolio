...
const Contact = () => {
  ...
  const sendEmail = (e) => {
    ...
    emailjs
      .sendForm(
        'service_yb9qrpy', // Asegúrate de que este ID sea correcto
        ...
        <div className='contact_content'>
          ...
          <div className='contact_info'>
            <div className='contact_card'>
              ...
              <span className='contact_card-data'>enzoarielheredia@gmail.com</span>
              <a href="https://mail.google.com/mail/?view=cm&fs=1&to=enzoarielheredia@gmail.com&su=Asunto&body=Cuerpo%20del%20mensaje" target="_blank" className='contact_button'>
            ...
            <div className='contact_card'>
              ...
              <span className='contact_card-data'>+54 9 3434479528</span>
              <a href="https://wa.me/5493434479528" target="_blank" className='contact_button'>
                Write me <i className='bx bx-right-arrow-alt contact_button-icon'></i>
              </a>
            </div>
            <div className='contact_card'>
              ...
              <span className='contact_card-data'>Enzo Heredia</span>
        ...
        <div className='contact_content'>
          ...
          <form ref={form} onSubmit={sendEmail} className='contact_form'>
            ...
            <div className='contact_form-div'>
              ...
              <textarea name="message" cols="30" rows="5" className='contact_form-input' placeholder='Write your project' required></textarea>
            </div>
